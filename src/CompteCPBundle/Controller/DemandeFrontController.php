...
class DemandefrontController extends Controller {
    ...
    public function indexCPPAction() {
        ...
        $entities = $em->getRepository('CompteCPBundle:Demande')->findBy(array('type' => "CPP","cin"=>1));
    ...
    public function indexB3Action() {
        ...
        $entities = $em->getRepository('CompteCPBundle:Demande')->findBy(array('type' => "B3","cin"=>1));
    ...
    public function indexCinAction() {
        ...
        $entities = $em->getRepository('CompteCPBundle:Demande')->findBy(array('type' => "Cin","cin"=>1));
