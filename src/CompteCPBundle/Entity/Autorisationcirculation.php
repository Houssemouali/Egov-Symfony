...
class Autorisationcirculation
{
    ...
    /**
     * @var \CompteCPBundle\Entity\Compte
     *
     * @ORM\ManyToOne(targetEntity="CompteCPBundle\Entity\Compte")
     * @ORM\JoinColumns({
     ...
     * Set cpp
     *
     * @param \CompteCPBundle\Entity\Compte $cpp
     * @return Autorisationcirculation
     */
    public function setCpp(\CompteCPBundle\Entity\Compte $cpp = null)
    {
        $this->cpp = $cpp;
     ...
     * Get cpp
     *
     * @return \CompteCPBundle\Entity\Compte 
     */
