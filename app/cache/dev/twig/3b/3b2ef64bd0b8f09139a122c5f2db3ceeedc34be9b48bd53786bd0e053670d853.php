...
/* EgovMainBundle:FrontOffice:listSONEDE.html.twig */
class __TwigTemplate_dec38d4b7c3e69f0aafdb1d1b343a0d66a8bd2b2492fe5ea8f1667ff652af729 extends Twig_Template
{
                ...
                <div class=\"row\">
                    <div class=\"col-sm-8 col-sm-offset-2\">
                        <div class=\"mbr-header mbr-header--center mbr-header--std-padding\">
                            <h2 class=\"mbr-header__text\">Liste de Mes Factures SONEDE</h2>
                        </div>
                        <div class=\"box-content\">
\t<table class=\"table table-bordered table-striped table-condensed table-hover datatable bootstrap-datable\">
        ...
        echo "<b>Numéro d'Identification de Facture</b></td>
    <td class=\"center\"";
        // line 107
    ...
    <td class=\"center\"";
        // line 109
        if ($this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : $this->getContext($context, "pagination")), "isSorted", array(0 => "a.Type"), "method")) {
            echo " class=\"sorted\"";
        }
        echo ">";
    ...
    <td class=\"center\"";
        // line 110
        if ($this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : $this->getContext($context, "pagination")), "isSorted", array(0 => "a.PayerAvant"), "method")) {
            echo " class=\"sorted\"";
        }
        echo ">";
        echo $this->env->getExtension('knp_pagination')->sortable($this->env, (isset($context["pagination"]) ? $context["pagination"] : $this->getContext($context, "pagination")), "", "a.PayerAvant");
        echo "<b>Payer Avant le</b></td>
    <td class=\"center\"";
        // line 111
        if ($this->getAttribute((isset($context["pagination"]) ? $context["pagination"] : $this->getContext($context, "pagination")), "isSorted", array(0 => "a.Montant"), "method")) {
            echo " class=\"sorted\"";
        }
        echo ">";
        echo $this->env->getExtension('knp_pagination')->sortable($this->env, (isset($context["pagination"]) ? $context["pagination"] : $this->getContext($context, "pagination")), "", "a.Montant");
        echo "<b>Montant</b></td>
    <td><b>Payement</b></td>
</tr>
\t    </thead>   
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["auto"]) {
            ...
            echo "</td>
                      ...
                      <td class=\"center\">";
            // line 121
            echo twig_escape_filter($this->env, $this->getAttribute($context["auto"], "Type", array()), "html", null, true);
            echo "</td>
                       <td class=\"center\">";
            // line 122
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["auto"], "PayerAvant", array()), "d/m/Y"), "html", null, true);
            echo "</td>
                       <td class=\"center\">";
            // line 123
            echo twig_escape_filter($this->env, $this->getAttribute($context["auto"], "Montant", array()), "html", null, true);
            echo "</td>
                        <td class=\"center\"><a class=\"btn btn-success\"  target=\"_blank\"><i class=\"glyphicon glyphicon-euro\"></i> </a></td>
...
\t\t ";
    ...
    {
        return "EgovMainBundle:FrontOffice:listSONEDE.html.twig";
    }
    ...
    {
        return array (  367 => 137,  363 => 135,  360 => 134,  349 => 210,  344 => 208,  339 => 206,  334 => 204,  330 => 203,  326 => 202,  262 => 140,  260 => 134,  255 => 131,  233 => 123,  229 => 122,  225 => 121,  220 => 119,  216 => 118,  209 => 117,  192 => 116,  180 => 111,  172 => 110,  164 => 109,  155 => 107,  151 => 106,  114 => 72,  58 => 19,  53 => 17,  49 => 16,  45 => 15,  41 => 14,  37 => 13,  30 => 9,  20 => 1,);
    }
}
/* <!DOCTYPE html>*/
/* <html>*/
...
/*             <thead>*/
/*             <tr>*/
/*                 <td class="center">{{knp_pagination_sortable(pagination, '', 'a.id') }}<b>Numéro d'Identification de Facture</b></td>*/
/*     <td class="center"{% if pagination.isSorted('a.cin') %} class="sorted"{% endif %}>{{ knp_pagination_sortable(pagination, '', 'a.cin') }}<b>Carte d'Identité Nationale</b></td>*/
/*    */
/*     <td class="center"{% if pagination.isSorted('a.Type') %} class="sorted"{% endif %}>{{ knp_pagination_sortable(pagination, '', 'a.Adresse') }}<b>Type<b></td>*/
/*     <td class="center"{% if pagination.isSorted('a.PayerAvant') %} class="sorted"{% endif %}>{{ knp_pagination_sortable(pagination, '', 'a.PayerAvant') }}<b>Payer Avant le</b></td>*/
/*     <td class="center"{% if pagination.isSorted('a.Montant') %} class="sorted"{% endif %}>{{ knp_pagination_sortable(pagination, '', 'a.Montant') }}<b>Montant</b></td>*/
/*     <td><b>Payement</b></td>*/
/* </tr>*/
/* 	    </thead>   */
/*              <tbody>*/
...
/*                     */
/*                       <td class="center">{{auto.Type}}</td>*/
/*                        <td class="center">{{auto.PayerAvant|date('d/m/Y')}}</td>*/
/*                        <td class="center">{{auto.Montant}}</td>*/
/*                         <td class="center"><a class="btn btn-success"  target="_blank"><i class="glyphicon glyphicon-euro"></i> </a></td>*/
/*                        */
/*                     </tr>*/
/* 						  </tbody>*/
