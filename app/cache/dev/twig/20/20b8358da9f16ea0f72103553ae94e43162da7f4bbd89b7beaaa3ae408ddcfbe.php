...
/* BackOfficebackBundle:frontOffice:demcin.html.twig */
class __TwigTemplate_921d2dde582b1c3810d87462f73d9afc78771ec798cdedf4f7ae595322188313 extends Twig_Template
{
                ...
                <div class=\"row\">
                    <div class=\"col-sm-8 col-sm-offset-2\">
                        <div class=\"mbr-header mbr-header--center mbr-header--std-padding\">
                            <h2 class=\"mbr-header__text\">DEMANDER CIN</h2>
                        </div>
                        ...
                        <form  method=\"POST\">
                            ...
                            <div class=\"form-group\">
                                <input type=\"text\" class=\"form-control\" name=\"nom_pere\" placeholder=\"nom pere*\">
                            </div>
                            <div class=\"form-group\">
                                <input type=\"text\" class=\"form-control\" name=\"nom_mere\" placeholder=\"nom_mere*\">
                            </div>
                              <div class=\"form-group\">
                                <input type=\"date\" class=\"form-control\" name=\"date_naissance\" required=\"\" placeholder=\"date naissance*\">
                            </div>
                            <div class=\"form-group\">
                                <input type=\"text\" class=\"form-control\" name=\"adresse\" placeholder=\"adresse*\">
                            </div>
                               <div class=\"form-group\">
                                <input type=\"text\" class=\"form-control\" name=\"sex\" required=\"\" placeholder=\"sex*\">
                            </div>
...
<footer class=\"mbr-section mbr-section--relative mbr-section--fixed-size\" id=\"footer1-2\" style=\"background-color: rgb(60, 60, 60);\">
  ...
  <script src=\"";
    ...
    {
        return "BackOfficebackBundle:frontOffice:demcin.html.twig";
    }
    ...
    {
        return array (  203 => 153,  198 => 151,  193 => 149,  188 => 147,  184 => 146,  63 => 28,  48 => 16,  44 => 15,  40 => 14,  36 => 13,  29 => 9,  19 => 1,);
    }
}
/* <!DOCTYPE html>*/
/* <html>*/
