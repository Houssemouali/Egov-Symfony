...
namespace Proxies\__CG__\Inter\CinBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Extraitnaissances extends \Inter\CinBundle\Entity\Extraitnaissances implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'nom', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'prenom', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'sexe', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'villeNaissance', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'dateNaissance', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'pere', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'mere', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'etatCivile', '' . "\0" . 'Inter\\CinBundle\\Entity\\Extraitnaissances' . "\0" . 'id'];
        }
