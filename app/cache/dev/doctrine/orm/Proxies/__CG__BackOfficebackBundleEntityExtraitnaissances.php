 ...
 */
class Extraitnaissances extends \BackOffice\backBundle\Entity\Extraitnaissances implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'nom', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'prenom', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'sexe', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'villeNaissance', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'dateNaissance', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'pere', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'mere', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'etatCivile', '' . "\0" . 'BackOffice\\backBundle\\Entity\\Extraitnaissances' . "\0" . 'id'];
        }
