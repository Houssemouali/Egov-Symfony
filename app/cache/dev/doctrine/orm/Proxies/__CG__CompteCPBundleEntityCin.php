 ...
 */
class Cin extends \CompteCPBundle\Entity\Cin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'adresse', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'profession', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'lieuCreation', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'dateCreation', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'photo', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'empreinte', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'numCin', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'id', '' . "\0" . 'CompteCPBundle\\Entity\\Cin' . "\0" . 'extrait'];
        }
