 ...
 */
class Extraitnaissances extends \Egov\MainBundle\Entity\Extraitnaissances implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'nom', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'prenom', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'sexe', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'villeNaissance', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'dateNaissance', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'pere', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'mere', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'etatCivile', '' . "\0" . 'Egov\\MainBundle\\Entity\\Extraitnaissances' . "\0" . 'id'];
        }
